...
<%@page import="Sneakers.SneakersError"%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="site-wrap">
            ...
            <div class="bg-light py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-0"><a href="admin.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Create Sneakers</strong></div>
                    </div>
                </div>
            </div>  
            ...
            <div class="site-section">
                <%
                    SneakersError SneakersError = (SneakersError) request.getAttribute("Glasses_ERROR");
                    if (SneakersError == null) {
                        SneakersError = new SneakersError();
                    }
                %>
                <div class="container">
                    <form action="MainController" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="h3 mb-3 text-black">Create Sneakers</h2>
                            </div>
                                ...
                                <div class="p-3 p-lg-5 border">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <span class="text-danger"><%= SneakersError.getSneakerID()%></span></br>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" id="brand" name="brand">
                                                ...
                                                <option value="ChromeHeart">Chrome Hearts</option>
                            ...
                            <div class="col-md-5 ml-auto">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="image" class="text-black">Image (.jpg / .png)</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input type="submit" class="btn btn-dark btn-lg btn-block" value="Create" name="action">
                                    </div>
