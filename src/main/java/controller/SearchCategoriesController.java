...
public class SearchCategoriesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(brand==null&&type!=null)phuKienList=dao.getAllPkByType(type);
            else if(type==null&&brand!=null)phuKienList=dao.getAllPkByBrand(brand);
            else if(type!=null&&brand!=null)phuKienList=dao.getAllPkByTypeBrand(type, brand);
